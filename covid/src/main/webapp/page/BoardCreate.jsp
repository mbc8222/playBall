...
<body>
	<div class='cr'>
		<form id='frm_summernote' method='post'>
			<div>
			...
			<div class='summernote'>
				<textarea id='summernote' name='content' cols="300"></textarea>
			</div>
			<input type='button' id='btn_create' value='작성'>
...
<script type="text/javascript" src="../js/BoardCreate.js"></script>
<script>
